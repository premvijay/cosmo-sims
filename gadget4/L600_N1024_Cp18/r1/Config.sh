...
PMGRID=2048                                   # basic mesh size for TreePM calculations
...
NUMBER_OF_MPI_LISTENERS_PER_NODE=2           # set such that the number of MPI-ranks per node and listener is maller than MAX_NUMBER_OF_RANKS_WITH_SHARED_MEMORY
