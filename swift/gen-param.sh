...
Gravity:
  ...
  comoving_DM_softening:         $softlen1 # Comoving Plummer-equivalent softening length for DM particles (in internal units).
  max_physical_DM_softening:     $softlen1    # Maximal Plummer-equivalent softening length in physical coordinates for DM particles (in internal units).
  comoving_baryon_softening:     $softlen0 # Comoving Plummer-equivalent softening length for baryon particles (in internal units).
  max_physical_baryon_softening: $softlen0    # Maximal Plummer-equivalent softening length in physical coordinates for baryon particles (in internal units).
...
Snapshots:
  ...
  output_list:         $dir_root/outputs-many-lin.list # (Optional) File containing the output times (see documentation in Parameter File section)
